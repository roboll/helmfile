...
- openSUSE: install via `zypper in helmfile` assuming you are on Tumbleweed; if you are on Leap you must add the [OBS](https://download.opensuse.org/repositories/devel:/kubic/) for your distribution version once before that command, or
